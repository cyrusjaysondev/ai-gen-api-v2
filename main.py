...
async def face_animate(
    ...
    watermark_image: bool = Form(False, description="Composite the Metfone GenAI logo (loaded once from /workspace/assets/metfone_genai_watermark_500.png) at the bottom-right of the final video. Stacks with `watermark` if both are set."),
